...
namespace BlazorBookstoreMVC.Controllers
{
    public class OrderLineItemsController : Controller
    {
        private readonly DBContext _context;

        public OrderLineItemsController(DBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.OrderLineItems != null ? 
                          ...
                          Problem("Entity set 'DBContext.OrderLineItems'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderLineItemId,OrderId,BookId,Quantity,Price")] OrderLineItem orderLineItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderLineItemId,OrderId,BookId,Quantity,Price")] OrderLineItem orderLineItem)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DBContext.OrderLineItems'  is null.");
            }
            var orderLineItem = await _context.OrderLineItems.FindAsync(id);
            if (orderLineItem != null)
            {
